...
describe('model registry', () => {
  ...
  it('登记 Detection 0.4.0 及包含 PP-YOLOE+ 四规格的九个稳定变体', () => {
    ...
    expect(model.assets.map((asset) => asset.bytes)).toEqual([23243834, 14813981, 6117685, 31954220, 16054567, 8225467, 94022904, 209181400, 394163636]);
